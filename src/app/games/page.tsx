...
const games = [
    { 
        city: 'Bengaluru', 
        activities: [
            { name: 'Tech Bingo', description: 'A fun bingo game with AI and tech terms.', path: '/bingo/bengaluru' }
        ] 
    },
  ...
  return (
    <main className="container mx-auto p-4 sm:p-6 md:p-8 min-h-screen">
      <header className="text-center mb-8">
        ...
        <p className="font-body text-muted-foreground mt-2 text-lg">Choose your city and let the games begin!</p>
      </header>
                    ...
                    <div className="grid gap-4 mt-4">
                      {game.activities.map(activity => (
                        <Card key={activity.name} className="bg-card/80">
                           <CardHeader>
                             <CardTitle className="font-body flex items-center gap-2"><Gamepad2/> {activity.name}</CardTitle>
